/*
** Lua binding: CEGUI
** Generated automatically by tolua++-1.0.92 on Fri Sep 14 09:53:50 2012.
*/
...
#ifndef TOLUA_DISABLE_tolua_CEGUI_CEGUI_FormattedListboxTextItem_getFormatting00
static int tolua_CEGUI_CEGUI_FormattedListboxTextItem_getFormatting00(lua_State* tolua_S)
{
...
#ifndef TOLUA_DISABLE_tolua_CEGUI_CEGUI_FormattedListboxTextItem_setFormatting00
static int tolua_CEGUI_CEGUI_FormattedListboxTextItem_setFormatting00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_CEGUI_CEGUI_createFormattedListboxTextItem00
static int tolua_CEGUI_CEGUI_createFormattedListboxTextItem00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"CEGUI");
   ...
   tolua_beginmodule(tolua_S,"FormattedListboxTextItem");
    tolua_function(tolua_S,"getFormatting",tolua_CEGUI_CEGUI_FormattedListboxTextItem_getFormatting00);
    tolua_function(tolua_S,"setFormatting",tolua_CEGUI_CEGUI_FormattedListboxTextItem_setFormatting00);
   tolua_endmodule(tolua_S);
   tolua_function(tolua_S,"createFormattedListboxTextItem",tolua_CEGUI_CEGUI_createFormattedListboxTextItem00);
  tolua_endmodule(tolua_S);
 tolua_endmodule(tolua_S);
 return 1;
}
