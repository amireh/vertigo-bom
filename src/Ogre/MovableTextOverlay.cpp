...
void MovableTextOverlay::update(Real timeSincelastFrame)
{
	...
	mpOvContainer->setPosition(1-(min_x + max_x + relTextWidth)/2, 1-max_y-0.02f);
	mpOvContainer->setDimensions(relTextWidth, relTextHeight*1.5f - 0.004f);

  //std::cout << "RTW: " << relTextWidth << ", RTH: " << relTextHeight << "\n";
}
